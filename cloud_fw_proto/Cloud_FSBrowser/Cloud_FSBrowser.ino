...
//Used for inital network generation to aquire network credentials
IPAddress apIP(192, 168, 1, 1);
const char* ap_network = "Magic Cloud";
...
void setup(void) {
  ...
  //create a wifi network to enable the user to enter network credentials
  // WiFi.mode(WIFI_AP);
  // WiFi.softAPConfig(apIP, apIP, IPAddress(255, 255, 255, 0));
  // DBG_OUTPUT_PORT.printf("Starting WiFi Network: %s\n", ap_network);
  // WiFi.softAP(ap_network);
